(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@aktin/utils'), require('@ngrx/store'), require('@ngrx/entity'), require('@ngrx/effects'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@aktin/utils', '@ngrx/store', '@ngrx/entity', '@ngrx/effects', 'rxjs'], factory) :
    (global = global || self, factory(global.case = {}, global.core, global.common, global.utils, global.store, global.entity, global.effects, global.rxjs));
}(this, function (exports, core, common, utils, store, entity, effects, rxjs) { 'use strict';
