...
public class ScriptManagerEndpoint {
     ...
     * woher kommt exception und was bedeutet sie?
     ...
     @Path("{uuid}/verify")
     @POST public Response queueFileVerification(@NotNull @PathParam("uuid") String uuid) {
     ...
     * @return Response with status 200
     ...
     @Path("{uuid}/import")
     @POST public Response queueFileImport(@NotNull @PathParam("uuid") String uuid) {
     ...
     * @return Response with status 200
     ...
     @Path("{uuid}/cancel")
     @POST public Response cancelFileProcessing(@NotNull @PathParam("uuid") String uuid) {
     ...
     * @return Response with status 200
     ...
     @Path("{uuid}/status")
     @GET public Response getFileProcessingStatus(@NotNull @PathParam("uuid") String uuid) {
